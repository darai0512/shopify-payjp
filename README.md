...
export PAYJP_PRIVATE_KEY='sk_test_xxx'
export PAYJP_OAUTH_CLIENT_ID='for_payid'
export SHOPIFY_HMAC_KEY='iU44RWxeik' # https://help.shopify.com/en/api/guides/payment-gateway/hosted-payment-sdk/develop-gateway
```
